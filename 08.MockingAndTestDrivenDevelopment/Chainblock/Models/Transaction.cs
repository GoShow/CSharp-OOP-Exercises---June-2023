...
public class Transaction : ITransaction
{
    ...
    public string From
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentException(TransactionExceptionMessages.FromNullOrWhiteSpace);
            }
    ...
    public string To
    {
        ...
        set
        {
            if (string.IsNullOrWhiteSpace(value))
            {
                throw new ArgumentException(TransactionExceptionMessages.ToNullOrWhiteSpace);
            }
