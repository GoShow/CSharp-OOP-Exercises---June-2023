...
public class ChainblockTests
{
    ...
    [Test]
    public void CountShouldReturnSameNumberAsNumberOfTransactionsAdded()
    {
        int expectedCount = 2;
    ...
    [Test]
    public void CountShouldReturnZeroWhenNoTransactionsAdded()
    {
        int expectedCount = 0;
        ...
        TransactionStatus fromStatus, TransactionStatus toStatus)
    {
        ...
        Assert.AreEqual(toStatus, testTransaction.Status);
    }
